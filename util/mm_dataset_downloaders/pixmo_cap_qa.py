...
def main():
    parser = argparse.ArgumentParser(
        description="Download PixMo-Cap-QA and fetch images from URLs"
    )
    parser.add_argument(
        "--output_dir",
        type=Path,
        default=Path("data/pixmo_cap_qa"),
        help="Root directory for PixMo-Cap-QA",
    )
    parser.add_argument(
        "--num_workers",
        type=int,
    ...
    print("Loading PixMo-Cap-QA metadata...")
    ...
    # Deduplicate URLs (many QA pairs share the same image)
    ...
    print("\n✅ PixMo-Cap-QA dataset preparation complete")
