...
def main():
    parser = argparse.ArgumentParser(
        description="Download PixMo-Cap and fetch all images concurrently"
    )
    parser.add_argument(
        "--output_dir",
        type=Path,
        default=Path("data/pixmo_cap"),
        help="Root directory for PixMo-Cap",
    )
    parser.add_argument(
        "--num_workers",
        type=int,
    ...
    print("Loading PixMo-Cap dataset metadata...")
    ...
    print("\n✅ PixMo-Cap dataset preparation complete")
